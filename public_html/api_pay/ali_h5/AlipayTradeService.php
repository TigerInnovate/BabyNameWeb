...
class AlipayTradeService {
	...
	function wapPay($builder,$return_url,$notify_url) {
		...
		include 'AlipayTradeWapPayRequest.php';
	...
	function Query($builder){
		...
		//打印业务参数
		$this->writeLog($biz_content);
		include 'AlipayTradeQueryRequest.php';
...
$this->writeLog(333);
	...
	function Refund($builder){
		...
		//打印业务参数
		$this->writeLog($biz_content);
		include 'AlipayTradeRefundRequest.php';
	...
	function Close($builder){
		...
		//打印业务参数
		$this->writeLog($biz_content);
		include 'AlipayTradeCloseRequest.php';
	...
	function refundQuery($builder){
		...
		//打印业务参数
		$this->writeLog($biz_content);
		include 'AlipayTradeFastpayRefundQueryRequest.php';
