layui.define('jquery',function(exports){var jQuery=layui.jquery;layui.link('/statics/ffsm/public/pc/extends/datetime/datetime.min.css');
	...
	function datetime(idname,options){jQuery('#'+idname).mobiscroll().datetime(options);}exports('datetime', datetime);})